...
import { FaUser, FaAddressBook, FaLink, FaUpload, FaTimes, FaCheckCircle } from "react-icons/fa";
...
export default function CreateBusinessProfile() {
      ...
      try {
        ...
        if (user) {
          ...
          if (existingBusiness?.[0]) {
            ...
            console.log("Found existing business profile:", business);
            
            const isProfileComplete = business.business_name && business.industry;
            
            if (isProfileComplete) {
              console.log("Business profile is complete, redirecting to view profile");
              navigate("/business-profile");
              return;
            } else {
              console.log("Business profile exists but incomplete, allowing user to complete it");
              setIsUpdating(true);
              ...
              setFormData({
                ...
                google_my_business: business.google_my_business || "",
              });
            }
          }
          ...
          if (profileData?.[0]?.user_type === "professional") {
            console.log("User is professional type, redirecting to create professional profile");
            navigate("/create-profile");
            return;
          }
          
          console.log("Allowing business profile creation/completion");
  ...
  return (
    <>
      {/* ✅ FIXED: CSS moved to separate style tag */}
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 to-purple-100">
          ...
          <div className="fixed top-4 right-4 z-50 animate-slide-in-right">
            <div className="bg-green-500 text-white px-6 py-4 rounded-lg shadow-lg flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm">Business profile {isUpdating ? 'updated' : 'created'} successfully</p>
              </div>
            </div>
          </div>
        )}
        ...
        <div className="bg-white shadow-xl max-w-2xl mx-auto mt-8 rounded-2xl p-8 border border-gray-100">
          <h2 className="text-2xl font-bold text-center mb-8 text-gray-800">
            {isUpdating ? "Complete Business Profile" : "Create Business Profile"}
          </h2>
