...
export default function CreateProfile() {
  ...
  // ✅ UPDATED: Replaced alert with toast and auto redirect
  const handleSubmit = async () => {
    try {
      ...
      if (error) {
        ...
        // ✅ UPDATED: Show toast instead of alert
        setShowToast(true);
        
        // ✅ UPDATED: Auto redirect after 2 seconds
        setTimeout(() => {
          navigate("/profile");
        }, 2000);
      }
          ...
          <div className="fixed top-4 right-4 z-50 animate-slide-in-right">
            <div className="bg-green-500 text-white px-6 py-4 rounded-lg shadow-lg flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm">Professional profile created successfully</p>
              </div>
            </div>
          </div>
        )}
