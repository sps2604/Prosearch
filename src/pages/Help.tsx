      ...
      <main className="flex-1 px-6 py-12 bg-gray-50">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-5xl mx-auto">
          <button
            ...
            className="bg-white shadow-md rounded-2xl p-6 hover:shadow-lg transition-all duration-200 border border-gray-200"
          >
            <i className="fas fa-search-plus text-3xl text-blue-500 mb-4"></i>
            <p className="font-medium text-gray-900">Apply for Job</p>
          </button>
          ...
          >
            ...
            <p className="font-medium text-gray-900">Search Professionals</p>
          </button>
        </div>
      </main>
